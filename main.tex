...
\uncover<2->{\includegraphics[width=\linewidth]{logo-zfit.png}} & & \uncover<2->{Aims to be the general purpose fitter with a Pythonic interface. Try it out: does it make your fits easier?} \\
