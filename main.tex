...
\uncover<3->{\includegraphics[width=1\linewidth]{logo-zarr.png}\vspace{-0.4 cm}} & & \uncover<3->{Delivers slices of an array dataset to distributed jobs.} \\

\uncover<4->{\includegraphics[width=1\linewidth]{logo-dask.png}\vspace{-0.4 cm}} & & \uncover<4->{Distributed processing with (and without) an array interface. \linebreak Records lazy calculations and replays them on remote workers.} \\
